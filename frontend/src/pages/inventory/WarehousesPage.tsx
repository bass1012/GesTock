    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        <div className="flex justify-center p-12">
          <div className="animate-spin rounded-full size-8 border-b-2 border-primary-500"></div>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {warehouses.map((w) => (
            <div key={w.id} className="card p-6 shadow-[inset_3px_0_0_0_theme(colors.primary.500)]">
                      ...
                      <button
                        onClick={() =>
                          setConfirmConfig({
                            ...
                            message: 'Voulez-vous vraiment supprimer cet entrepôt ?',
