    ...
    if (isSuccess) {
        return (
            <div className="min-h-screen bg-[#09090b] flex flex-col items-center justify-center p-8 text-center">
                ...
                <p className="text-gray-400">Votre nouveau mot de passe a été enregistré.<br/>Redirection vers votre espace...</p>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
                <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-primary-600/10 blur-[120px] rounded-full"></div>
            ...
            <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in duration-700">
                <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-10 rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.6)] relative overflow-hidden">
                    {/* Inner Glow */}
                    <div className="absolute -top-24 -left-24 w-48 h-48 bg-primary-500/10 blur-[60px] rounded-full"></div>
                    
                    <div className="flex justify-center mb-10">
                        <div className="w-20 h-20 bg-gradient-to-br from-primary-500/20 to-blue-600/20 rounded-[2rem] flex items-center justify-center border border-white/10 shadow-inner group animate-float">
                            <ShieldCheck size={40} className="text-primary-400 group-hover:scale-110 transition-transform" />
                        </div>
                    </div>
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-400 text-sm font-medium">Configurez votre nouvel accès pour déverrouiller vos outils logistiques.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Confirmer le Mot de Passe</label>
                            <div className="relative">
                                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500" size={18} />
                                <input
                                    type={showPassword ? 'text' : 'password'}
