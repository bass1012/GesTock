    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 text-white p-12 flex-col justify-between relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute -top-24 -left-24 size-96 rounded-full bg-white/20 blur-3xl"></div>
          <div className="absolute bottom-0 right-0 size-80 rounded-full bg-white/10 blur-3xl"></div>
        </div>
        <div className="relative z-10">
          ...
          <p className="text-lg text-primary-200 leading-relaxed max-w-md">
            Créez votre espace en quelques secondes. Aucune carte bancaire requise pour le plan
            Starter.
          </p>
        </div>
