        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 sticky top-0 z-30">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        {hasUnread && alerts.length > 0 && (
                            <span className="absolute top-1.5 right-1.5 w-2.5 h-2.5 bg-red-500 rounded-full border-2 border-white box-content animate-pulse"></span>
                        )}
                        {!hasUnread && alerts.length > 0 && (
                        ...
                        <>
                            ...
                            <div className="absolute right-0 mt-2 w-80 bg-white border border-gray-100 rounded-xl shadow-[0_4px_24px_rgba(0,0,0,0.06)] z-20 overflow-hidden">
                                <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
                                    <h3 className="font-semibold text-gray-900 text-sm">Notifications ({alerts.length})</h3>
                                    {alerts.length > 0 && (
                                        <button 
                                ...
                                <div className="max-h-96 overflow-y-auto">
                                    {alerts.length > 0 ? (
                                        alerts.map((alert) => (
                                            <div key={alert.id} className="px-4 py-3 hover:bg-gray-50 transition-colors border-b border-gray-50">
                                                <div className="flex gap-3">
                                                    ...
                                                    <div>
                                                        <p className="text-sm font-medium text-gray-900 mb-0.5">Stock bas : {alert.name}</p>
                                                        <p className="text-xs text-gray-500 mb-2 leading-relaxed">
                                                            Le stock est de <span className="font-bold text-red-600">{alert.currentStock} {alert.unit}</span>. 
                ...
                <div className="flex items-center gap-3 pl-2 border-l border-gray-200">
                    <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center relative">
