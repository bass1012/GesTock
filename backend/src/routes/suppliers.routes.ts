...
router.post('/', requireRole('admin', 'manager'), suppliersController.create)
router.put('/:id', requireRole('admin', 'manager'), suppliersController.update)
router.delete('/:id', requireRole('admin', 'manager'), suppliersController.delete)
